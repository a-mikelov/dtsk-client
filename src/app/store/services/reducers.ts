...
export const heroReducer = createReducer(
  initialState,
  on(getServicesAction, (state): ServicesStateInterface => ({
    ...state,
    isLoading: true,
  })),
  on(getServiceSuccessAction, (state, {data}): ServicesStateInterface => ({
    ...state,
    isLoading: false,
    data
  })),
  on(getServicesFailureAction, (state, {backendErrors}): ServicesStateInterface => ({
    ...state,
    isLoading: false,
    backendErrors
  }))
